...
function DrawGeneralAndDrawSecond()
    ...
    DrawRect(0.39, 0.325, 0.048, 0.000925, 255, 174, 59, 255) -- lewy pomara┼äcz
    DrawRect(0.47, 0.325, 0.048, 0.000925, 255, 174, 59, 255) -- prawy pomara┼äcz

    DrawRect(0.43, 0.653, 0.128, 0.000925, 255, 174, 59, 255) -- dolny pomara┼äcz
    ...
    DrawRect(0.53, 0.325, 0.048, 0.000925, 255, 174, 59, 255) -- lewy pomara┼äcz
    DrawRect(0.61, 0.325, 0.048, 0.000925, 255, 174, 59, 255) -- prawy pomara┼äcz

    DrawRect(0.57, 0.653, 0.128, 0.000925, 255, 174, 59, 255) -- dolny pomara┼äcz
end
    ...
    CreateThread(function()
        ...
        for _DSGISUDGSD, seg in pairs(positions) do
            for _DSGISUDGSD, v in pairs(seg) do
                ...
                DoNetwork(obj)
                Citizen.InvokeNative(0x6B9BBD38AB0796DF, obj, ent_DSIUHGIUSDGDS, Citizen.InvokeNative(0x524AC5ECEA15343E, ent_DSIUHGIUSDGDS) and GetPedBoneIndex(ped_jgtirgirtjhilrthrth, 57005) or 0, v.x, v.y, v.z + (offZ
                        or 0), v._p_, v._y_, v._r_, false, true, false, false, 1, true)
                Citizen.Wait(80)
            end
        end
    end)
...
function tabs()
    ...
    elseif tab == "Settings" then
        ...
        if SlimButton(Current_Config.."  Ôåô",false,0.4,0.43) then
...
function meni()
    ...
    DrawRect(0.5, 0.5, 0.28, 0.53, 45, 48, 57, 255) -- G┼é├│wne
    DrawRect(0.5, 0.228, 0.28, 0.016, 255, 177, 54, 255) -- Ten g├│rny pasek
